...
if __name__ == "__main__":
    event_list = {
        "2021": [
            ["元旦假期", "0101", "0104"],
            ["春节假期", "0211", "0218"],
            ["【补休上班】春节补休上班", "0207", "0208"],
            ["【补休上班】春节补休上班", "0220", "0221"],
            ["清明节假期", "0403", "0406"],
            ["劳动节假期", "0501", "0506"],
            ["【补休上班】劳动节补休上班", "0425", "0426"],
            ["【补休上班】劳动节补休上班", "0508", "0509"],
            ["端午节假期", "0612", "0615"],
            ["中秋节假期", "0919", "0922"],
            ["【补休上班】中秋节补休上班", "0918", "0919"],
            ["国庆日假期", "1001", "1008"],
            ["【补休上班】国庆补休上班", "0926", "0927"],
            ["【补休上班】国庆", "1009", "1010"],
        ],
        "2022": [
            ["元旦假期", "0101", "0104"],
            ["【补休上班】春节补休上班", "0129", "0131"],
            ["春节假期", "0131", "0207"],
            ["【补休上班】清明节补休上班", "0402", "0403"],
            ["清明节假期", "0403", "0406"],
            ["【补休上班】劳动节补休上班", "0424", "0425"],
            ["劳动节假期", "0430", "0505"],
            ["【补休上班】劳动节补休上班", "0507", "0508"],
            ["端午节假期", "0603", "0606"],
            ["中秋节假期", "0910", "0913"],
            ["国庆日假期", "1001", "1008"],
            ["【补休上班】国庆补休上班", "1008", "1010"],
        ]
    }
